...
- **2026-06-14** : ✉️ corrections e-mail — destinataire = hello@kalendi.fr ; envoi conditionné à l'existence d'un compte-rendu non envoyé (colonne `emailed`), scénario en polling 6h-22h → plus de mail vide même si la maj de 6h n'a pas eu lieu (ordi en veille), envoi une fois la maj faite. Correction event UFC Maison Blanche → nuit dim. 14 → lun. 15 juin.
